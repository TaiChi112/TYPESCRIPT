...
const linkedin_url: string =
  "https://www.linkedin.com/in/anothai-vichapaiboon-a88790260/";
export const Footer = () => {
  return (
    <>
          ...
          >
            <ul>
              ...
              <li style={{ margin: "10px" }}>
                <a href={youtube_url} target="blank_youtube">
                  Youtube
                </a>
              </li>
              <li style={{ margin: "10px" }}>
                <a href={github_url} target="blank_github">
                  Github
                </a>
              </li>
              <li style={{ margin: "10px" }}>
                <a href={linkedin_url} target="blank_linkedin">
                  Linkedin
                </a>
              </li>
