  ...
  useEffect(() => {
    const initMap = (): void => {
      ...
      const infoWindow = new google.maps.InfoWindow({
        content:
          '<div style="color: black;"><h1>Bangkok</h1><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque quibusdam porro eum, rem deleniti quae sit consequuntur vitae ipsa in optio fugit accusamus dolores! Minima quibusdam tenetur dignissimos. Veniam, placeat?</p></div>', // ข้อความที่ต้องการแสดงใน InfoWindow
      });
